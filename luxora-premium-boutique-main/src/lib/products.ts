...
export type Product = {
  ...
  price: number;
  compareAt?: number;
  category: "women" | "men" | "accessories" | "jewelry";
  subcategory: string;
...
// Unsplash editorial fashion imagery — production would use Cloudinary.
const img = (id: string, w = 1200) =>
  `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=${w}&q=80`;

export const products: Product[] = [
  {
    id: "p1", slug: "noir-silk-evening-gown",
    name: "Noir Silk Evening Gown",
    tagline: "Maison Atelier — FW Couture",
    price: 2480, compareAt: 2950,
    ...
    rating: 4.9, reviews: 124, isNew: true, isBestSeller: true, stock: 8,
  },
  {
    id: "p2", slug: "monogram-cashmere-coat",
    ...
    rating: 4.8, reviews: 86, isBestSeller: true, stock: 12,
  },
  {
    id: "p3", slug: "midnight-tailored-tuxedo",
    ...
    rating: 4.9, reviews: 67, isNew: true, stock: 5,
  },
  {
    id: "p4", slug: "or-noir-leather-tote",
    ...
    rating: 4.9, reviews: 248, isBestSeller: true, stock: 16,
  },
  {
    id: "p5", slug: "constellation-gold-necklace",
    ...
    rating: 5.0, reviews: 41, isNew: true, stock: 4,
  },
  {
    id: "p6", slug: "obsidian-stiletto-heels",
    name: "Obsidian Stiletto Heels",
    tagline: "Soirée Edit",
    price: 980,
    category: "women", subcategory: "Shoes",
    ...
    rating: 4.7, reviews: 92, stock: 14,
  },
  {
    id: "p7", slug: "ivory-silk-blouse",
    ...
    rating: 4.6, reviews: 158, isBestSeller: true, stock: 22,
  },
  {
    id: "p8", slug: "gentleman-oxford-derby",
...
export const mockOrders = [
  { id: "LX-2026-0418", date: "2026-05-22", total: 4370, status: "Delivered", items: 2, tracking: "Delivered to recipient — Paris 8e" },
  { id: "LX-2026-0392", date: "2026-05-14", total: 1890, status: "In Transit", items: 1, tracking: "Departed Milan distribution center" },
  { id: "LX-2026-0317", date: "2026-04-30", total: 2480, status: "Processing", items: 1, tracking: "Hand-finishing at atelier" },
];
...
export const relatedProducts = (id: string, cat: string) =>
